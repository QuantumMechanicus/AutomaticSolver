...
../NonLinearOptimizator --n_iters 4 $s_left $s_right --left_inl_f $ones --n_pic 9 --right_inl_f $twos --fund_f ${out_dir}all.ff --lambda_f ${out_dir}all.ll --nlambda 2 --nlambda2 1 --h 4912 --w 7360
